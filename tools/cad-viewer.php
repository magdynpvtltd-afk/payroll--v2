...
require_login();
$page_title    = 'CAD viewer · MagDyn';
$current_page  = 'cad-viewer.php';
$trigger_style = 'dark';
$cdn_scripts   = [];
...
<style>
  ...
  /* Belt-and-suspenders: ensure sidebar layout works even if magdyn-base.css
     fails to load or gets cached at an older version. */
  html, body { height: 100%; margin: 0; }
  .layout { display: flex !important; min-height: 100vh; }
  .sidebar { width: 240px !important; flex-shrink: 0 !important; }
  .main { flex: 1 !important; min-width: 0 !important; }
  ...
  .toolbar .btn { padding: 6px 12px; font-size: 12.5px; }
  .toolbar .btn.active {
  ...
  /* MagDyn embed mode (iframed inside /tools.php?tool=cad). The CAD
     viewer has no sub-tools so the inner sidebar adds only redundant
     branding; hide it and let the canvas fill the iframe. */
...
<aside class="sidebar">
    ...
    <div class="brand">
        ...
        <div class="brand-text">
            ...
            <div class="brand-sub">DXF · STEP · STL · IGES</div>
        </div>
    </div>
</aside>
...
<div class="wrap">
  ...
  <header class="page-head">
    ...
    <p class="muted">Open DXF, STL, OBJ, STEP, IGES, and other formats in your browser. No server upload, no plugins.</p>
    <div class="tags">
  ...
  <footer>Single-file viewer · works offline once loaded</footer>
</div>
